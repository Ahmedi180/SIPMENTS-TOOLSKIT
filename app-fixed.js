...
// company contains any digit -> reject row
...
// Strong Sialkot detection (keeps rows even with special chars)
const cityClean = city.replace(/[^A-Z]/g, "");
if (!(cityClean.includes("SIALKOT") || cityClean.includes("SKT"))) return false;
